...
```{r keep_scales, fig.show='hold', out.width='40%'}
...
If you want to highlight each facet individually, set `use_facet_vars` to `TRUE`.
...
```{r use_facet_vars, fig.show='hold', out.width='40%'}
d <- data.frame(
